...
#define STRING_CONFIG_H_AUTHOR "(PTK, PNP-PM460)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Placemat 460"
...
//  #define DELTA_HEIGHT 294.35 // get this value from auto calibrate
  #define DELTA_HEIGHT 228.36 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.06, -0.60, 0.0 } // get these from auto calibrate
  ...
  #define DELTA_RADIUS 135.23 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.25, 0.05, -0.30 } // get these values from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, /* 96 */ 89, 1 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 200, 100 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {3000,3000,3000,3000,1500 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -61.31   // Z offset: -below +above  [the nozzle]
...
#define MANUAL_Z_HOME_POS 50 // Distance between the nozzle to printbed after homing
